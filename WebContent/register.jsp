...
<%@ include file="jsp/menu.jsp" %>
		  		...
		  		<form class="form" role="form">
				    ...
				    <label for="inputUsername"><span class="glyphicon glyphicon-user"></span> Benutzername</label>
				    <input type="text" class="form-control" id="inputUsername" placeholder="">
				  </div>
				  <div class="form-group" style="margin-bottom: 5px;">
				    <label for="inputEmail"><span class="glyphicon glyphicon-envelope"></span> E-Mail-Adresse</label>
				    <input type="text" class="form-control" id="inputEmail" placeholder="">
				  </div>
				  <div class="form-group" style="margin-bottom: 5px;">
				    <label for="inputPassword"><span class="glyphicon glyphicon-lock"></span> Passwort</label>
