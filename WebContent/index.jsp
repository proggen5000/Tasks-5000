				...
				<c:if test="${login}">
			  		...
			  		<div class="list-group">
						<a href="task.jsp?mode=view&id=X" class="list-group-item">
							...
							<p class="list-group-item-text">Microsoft Windows Core Development Team / Windows 8.1</p>
						</a>
						<a href="task.jsp?mode=view&id=X" class="list-group-item">
							<div class="task-progress"><div class="progress">
							...
							<p class="list-group-item-text">Microsoft Windows Core Development Team / Windows 9</p>
						</a>
						<a href="task.jsp?mode=view&id=X" class="list-group-item">
							<div class="task-progress"><div class="progress">
